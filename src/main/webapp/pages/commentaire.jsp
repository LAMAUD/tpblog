		...
		<div class="panel">
			<header class="panel-heading no-b col-lg-offset-2">
				<h1 class="h3 text-primary mt0">
					<spring:message code="create.commentaire" text="default text" />
				</h1>

				<div class="panel-body">
					<c:url var="createCommentaire" value="/commentaire/save.do" />
					<form:form action="${createCommentaire}" commandName="commentaire"
						method="GET">
<%-- 						<form:errors path="*" cssClass="errorblock" element="div"></form:errors> --%>
						<form:hidden path="id" />
						<div class="form-group">
							<label for="texte"> <spring:message code="label.com"
									text="default text" />
							</label>
							<form:input type="text" class="form-control" id="texte" path="texte"
								placeholder="texte" />
						</div>
