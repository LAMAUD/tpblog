		...
		<header class="header navbar shadow">
			<div class="col-lg-12 col-md-12 col-xs-12">
				<div class="brand">
					...
					<!-- logo -->
					<a href="<c:url  value="/auteur/list.do" />" class="navbar-brand">
						<img height="150" src="${urlResources}/img/moi.jpg" alt=""
				...
				<div class="container">
					<nav class="navbar navbar-default">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a data-toggle="drowpdown" >Accueil<b
									class="caret"></b></a>
							...
							<sec:authorize ifAllGranted="ROLE_ADMIN">
								<li><a href="<c:url  value="/auteur/save.do" />"><spring:message
											code="create.auteur" text="default text" /></a></li>
							</sec:authorize>
							<li><a href="<c:url  value="/categorie/save.do" />"><spring:message
										code="label.categorie" text="default text" /></a></li>
						</ul>
					</nav>
				</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="off-right"><a href="#" data-toggle="dropdown">
						...
						<ul class="dropdown-menu animated fadeInRight">
							...
							<li><a href="${urlAuteurUpdate}"><spring:message
										code="my.account" text="Update Auteur" /></a></li>
